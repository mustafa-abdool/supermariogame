...
def standingCheck(jumpflag,x,y,mx,my,deltax): #YOU DON'T NEED TO PASS IN PLATFORMLISTTT
   ...
   # someflag=False
    bottom=Rect(400,y+33,34,4) # its 400 because that will always be his position
...
def makeplatforms(): #makes some platforms 
    list1=[[Rect(0,600-32,2000,20),"block 1","none"],[Rect(800,450,32,32),"question block","mushroom"],[Rect(900,450,32,32),"question block","mushroom"],[Rect(1000,450,32,32),"question block","mushroom"]] #bottom most layer, 
    barriers=[]
    sidebarriers=[]
    platforms2=[]
...
def jump(x,y,intial_velocity,delta_x,gravity_change,pictures,boolean,mx,my,oldx): # make intial velocity negative, boolean represents left jump image
    ...
    #for i in range...maybe make a range and go through it, might make collisions better 
        ...
        if State=="Bounce2" or State=="Bounce3":
            return jump(x,y,-2,0,3,standing,boolean,mx,my,oldx) #makes him fall really fast 
        Deathcheck(x,y)
       # print (x,y)
